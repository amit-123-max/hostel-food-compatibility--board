...
2. **State Management:** Keep it simple. Use native state management provided by the UI framework (e.g., React `useState`, `useReducer`). Do NOT introduce complex state management libraries like Redux, MobX, or Zustand.
